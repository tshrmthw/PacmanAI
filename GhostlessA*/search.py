...
def depthFirstSearch(problem):
    ...
    frontier = util.Stack() #New stack frontier
    frontier.push((start,[]))
    ...
    while not frontier.isEmpty():
        ...
        if node[0] not in explored:
            ...
            for child in problem.getSuccessors(node[0]):
                ...
                frontier.push((child[0],path))  #Add child to the stack
        ...
        while not frontier.isEmpty():
            ...
            for child in problem.getSuccessors(node[0]):
                if (child[0] not in explored) and (child not in frontier.heap):
                    ...
                    frontier.push((child[0],path,cost,heuristicCosts),f)  #Add child to the frontier
